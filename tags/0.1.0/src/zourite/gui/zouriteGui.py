...
class ZouriteGui():
    ...
    def show_about_dialog(self, widget, data):
       ...
       '''
       self.show_note_information(
                 "Zourite \n"
                 "a networking application\n"
                 "by Thierry Bressure - www.bressure.net")
    ...
    def select_an_update_network_new(self, netUpdateConn):
        ...
        if netUpdateConn.type == 'CONN': # HOw to test     
...
class SettingsView(ZouriteStackableWindow):
    ...
    def init_center_view(self, centerview):
        ...
        # TODO add the plugin configuration
